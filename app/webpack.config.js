...
module.exports = {
  entry: {
    ...
    listProducts: path.resolve(__dirname, "app/assets/js/list-products.js"),// listProducts: "./list-products.js",
    addProducts: path.resolve(__dirname, "app/assets/js/add-products.js"),// addProducts: "./add-products.js",
  },
  output: {
